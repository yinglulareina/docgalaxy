...
public class NavigationResult {
    ...
    public NavigationResult(List<RouteStep> route, String summary, boolean isFallback) {
        this.route = route;
    ...
    public static NavigationResult fallback(List<String> topKNoteIds) {
        List<RouteStep> steps = IntStream.range(0, topKNoteIds.size())
            ...
            .toList();
        return new NavigationResult(steps, "AI unavailable. Showing most relevant notes.", true);
    }
